...
class UsrRulesService {
     ...
     * Find list of rules by query
     */
    find(streamId, search, from, to, eventSeverity, isActiveRule, eventType, includeSysRules, sort, page, size) {
        const params = [];
        if (streamId != null) {
            params.push(`streamId=${streamId}`);
        }
        ...
        if (isActiveRule != null) {
            params.push(`isActiveRule=${isActiveRule}`);
        }
        if (eventType != null) {
